...
#define CONFIG_SPL_BSS_START_ADDR (CONFIG_SYS_SPL_RAM_BASE+CONFIG_SYS_SPL_RAM_SIZE-CONFIG_SPL_BSS_MAX_SIZE)
#define CONFIG_SYS_MMCSD_RAW_MODE_KERNEL_SECTOR 0
#define CONFIG_SYS_MMCSD_FS_BOOT_PARTITION 1
#define CONFIG_SYS_SPL_KERNEL_ADDR 0x80080000
#define CONFIG_SYS_SPL_ARGS_ADDR (CONFIG_SYS_SPL_KERNEL_ADDR-SZ_32K-SZ_16K)
